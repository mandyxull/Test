...
namespace Mandy.Blog.Authorize.lmpl
{
    public class AuthorizeService : MandyBlogApplicationServiceBase, IAuthorizeService
    {
        ...
        public async Task<ServiceResult<string>> GenerateTokenAsync(string access_token)
        {
            ...
            return await _authorizeCacheService.GenerateTokenAsync(access_token, async () =>
            {
                ...
                var claims = new[] {
                    ...
                    new Claim(ClaimTypes.Email, user.Html_url),

...
namespace Mandy.Blog.Application.Caching.Authorize.lmpl
{
    public class AuthorizeCacheService : MandyBlogApplicationCachingServiceBase, IAuthorizeCacheService
    {

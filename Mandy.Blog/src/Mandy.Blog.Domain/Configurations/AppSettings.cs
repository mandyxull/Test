...
namespace Mandy.Blog.Domain.Configurations
{
    /// <summary>
    ...
    public class AppSettings
    {
        ...
        /// ConnectionStrings
        /// </summary>
        public static string ConnectionStrings => _config["ConnectionStrings:Default"];//_config.GetConnectionString(EnableDb);
        /// <summary>
        /// Caching
        /// </summary>
